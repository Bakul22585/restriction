...
export class HttpUtilsService {
	...
	baseFilter(_entities: any[], _queryParams: QueryParamsModel, _filtrationFields: string[] = []): QueryResultsModel {
		// Filtration
		// let entitiesResult = this.searchInArray(_entities['data'], _queryParams.filter, _filtrationFields);
		...
		queryResults.items = _entities['data'];
		queryResults.totalCount = _entities['total_record'];
		return queryResults;
	}
